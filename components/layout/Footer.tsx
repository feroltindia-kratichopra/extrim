...
import { COMPANY, PRODUCTS, NAV_LINKS } from '@/lib/data';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href={COMPANY.social.twitter} className="w-9 h-9 rounded-full bg-white/10 hover:bg-gold flex items-center justify-center transition-colors" aria-label="Twitter">
